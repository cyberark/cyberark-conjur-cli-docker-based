# docker 17.06 will let use do this:
...
RUN gem uninstall bundler -i /usr/local/lib/ruby/gems/2.1.0 bundler || true && \
  ...
  gem uninstall bundler -i /usr/local/lib/ruby/gems/2.3.0 bundler || true && \
  gem uninstall bundler -i /usr/local/lib/ruby/gems/2.4.0 bundler || true && \
